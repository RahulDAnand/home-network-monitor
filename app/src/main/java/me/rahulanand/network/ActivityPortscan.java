...
final public class ActivityPortscan extends TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (host.hostname != null && !host.hostname.equals(host.ipAddress)) {
            ((TextView) findViewById(R.id.host)).setText("Device: "+host.hostname + "");
        } else {
            ((TextView) findViewById(R.id.host)).setText(host.ipAddress);
        }
        // yeh maine likha hai alag se line pe ip dikhane ke liye
        TextView ip = (TextView) findViewById(R.id.textView2);
        if (host.hostname != null && !host.hostname.equals(host.ipAddress)) {
            ip.setText("IP: " +host.ipAddress+"");
        } else {
            ((TextView) findViewById(R.id.textView2)).setText("No IP Found");
        }
        // MAC Address
        TextView hw = (TextView) findViewById(R.id.mac);
        if (host.hardwareAddress != null && !host.hardwareAddress.equals(NetInfo.NOMAC)) {
            hw.setText("MAC: " +host.hardwareAddress+"");
        } else {
            hw.setVisibility(View.GONE);
        }

        // Vendor name
        TextView nic = (TextView) findViewById(R.id.list);
        ...
        tabHost.addTab(tabHost.newTabSpec("tab_open").setIndicator(
                ...
                getResources().getDrawable(R.drawable.closed)).setContent(R.id.list_open));
        ...
        // hack to have the view holding the tabs
    ...
    private class PortsAdapter extends ArrayAdapter<String> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (host.services != null) {
                ...
                holder.port.setText(port + "" + " (" + service + ")");
